...
use snarkos_lite_node_router::{Outbound, Routing};
use snarkos_lite_node_tcp::protocols::{Disconnect, Handshake, OnConnect};
...
async fn test_connection_cleanups() {
    ...
    for i in 0..NUM_CONNECTIONS {
        ...
        deadline!(Duration::from_secs(3), move || node0
            .router()
